...
The motion packet gives physics data for all the cars being driven. N.B. For the
normalised vectors below, to convert to float values divide by 32767.0f – 16-bit
signed values are used to pack the data and on the assumption that direction
...
to see your own car setup, regardless of the “Your Telemetry” setting.
...
This packets gives a more in-depth details about tyre sets assigned to a vehicle
during the session.
